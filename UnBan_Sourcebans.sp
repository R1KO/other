/*
1.0.0 beta 	-	Релиз 1-й бета версии плагина
1.0.1 beta	-	Сделана сортировка банов по дате бана
1.0.2 beta	-	Изменен принцип работы плагина
				Минимизовано меню вывода банов
				Вся информация о бане и действия над ним перенесены в отдельное меню
